# Description
description 'This builds the basic scaffolding for your Style Tiles project without a separate index file'
...
Congratulations! You just have built the basic scaffolding for getting started without a separate index file.
